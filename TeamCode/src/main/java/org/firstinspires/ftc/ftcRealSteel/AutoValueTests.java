...
@TeleOp(name = "value testing auto")
public class AutoValueTests extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("forward dis:", forwardtest);
            telemetry.addData("rotate dis:", rotatetest);
